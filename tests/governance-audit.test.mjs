...
test('local audit survives restart, detects edits, and contains no proposal values or credentials', async () => {
  ...
  try {
    ...
    const circular = { id: 'CIRCULAR', author: 'astra', baseVersion: bundle.manifest.version, summary: 'invalid', changes: [], tradeoffs: [], unresolved: [] };
    ...
    const base = { baseVersion: bundle.manifest.version, summary: 'private proposal text', tradeoffs: [], unresolved: [] };
...
test('audit write failure cannot acknowledge a proposal or approval', async () => {
  ...
  const proposal = { id: 'FAIL-A', author: 'astra', baseVersion: bundle.manifest.version, summary: 'x', changes: [{ path: 'tokens.radius.md.$value', value: '8px' }], tradeoffs: [], unresolved: [] };
