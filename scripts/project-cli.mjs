...
async function main([command,configPath,...args]) {
  if(!command||!configPath)throw new Error('Usage: project-cli.mjs validate|serve|report|preview|apply|undo <project.json> [arguments]');
  const project=await loadProject(configPath);
